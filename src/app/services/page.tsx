              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-orange-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-orange-800 mb-2">Expert Knowledge</h4>
                    <p className="text-orange-700 text-sm">
                      Stay current with the latest tax laws and regulations
                    </p>
                  </div>
                  <div className="bg-orange-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-orange-800 mb-2">Maximize Deductions</h4>
                    <p className="text-orange-700 text-sm">
                      Identify all eligible deductions to minimize your tax liability
                    </p>
                  </div>
                  <div className="bg-orange-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-orange-800 mb-2">Year-Round Support</h4>
                    <p className="text-orange-700 text-sm">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Organized, accurate financial records to keep your business running smoothly
              </p>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <h4 className="font-semibold text-gray-800 mb-2">Financial Clarity</h4>
                    <p className="text-gray-600 text-sm">
                      Clear view of your business performance and cash flow
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <h4 className="font-semibold text-gray-800 mb-2">Tax Ready</h4>
                    <p className="text-gray-600 text-sm">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Streamlined processes to manage client relationships and projects effectively
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-orange-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-orange-800 mb-2">Cloud-Based</h4>
                    <p className="text-orange-700 text-sm">
                      Access your data securely from anywhere, anytime
                    </p>
                  </div>
                  <div className="bg-orange-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-orange-800 mb-2">Automated Workflows</h4>
                    <p className="text-orange-700 text-sm">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Whether you&apos;re starting a new business, facing financial challenges, 
              or need strategic planning, I&apos;m here to help with personalized consultation.
            </p>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg max-w-2xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6 text-left">
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Business Setup</h4>
                  <p className="text-gray-600 text-sm">
                    Entity selection, accounting system setup, and compliance guidance
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Financial Review</h4>
                  <p className="text-gray-600 text-sm">
                    Analyze your current financial situation and identify opportunities
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Growth Planning</h4>
                  <p className="text-gray-600 text-sm">
                    Strategic financial planning for business expansion and scaling
                  </p>
                </div>
                <div>
